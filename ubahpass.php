...
<div class="container-fluid" style="background-color: #7fa1ff;">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top">
        <div class="col-md-4 d-flex align-items-center">
            ...
            <span class="text-body-secondary">©Copyright. by 21552011119_Kelompok2_TIF221PA_UASWEB1</span>
        </div>
    </footer>
</div>
...
<script>
    function gantiPass() {
        ...
        axios.post('https://client-server-arik.000webhostapp.com/ubahpassword.php', formData, {
            headers: {
