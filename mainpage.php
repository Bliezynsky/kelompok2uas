...
<footer class="container-fluid mt-2" style="background-color: #7fa1ff;">
    <div class="footer-content py-3 border-top d-flex flex-wrap justify-content-between align-items-center">
        <div class="col-md-4 d-flex align-items-center">
            ...
            <span class="mb-3 mb-md-0 text-body-secondary">© Copyright. by 21552011119_Kelompok2_TIF221PA_UASWEB1</span>
        </div>
    </div>
</footer>
...
<script>
    ...
    function fetchData() {
        axios.get('https://client-server-arik.000webhostapp.com/readproduk.php')
    ...
    function beliProduk() {
        ...
        axios.post('https://client-server-arik.000webhostapp.com/addbeli.php', data)
            .then(function(response) {
