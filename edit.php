...
<script>
    function getData() {
        ...
        axios.post('https://client-server-arik.000webhostapp.com/dataproduk.php', formData)
    ...
    function editProduk() {
        ...
        axios.post('https://client-server-arik.000webhostapp.com/editproduk.php', formData, {
            headers: {
